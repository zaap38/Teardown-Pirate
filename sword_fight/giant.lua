...
function animatorPoses(actionValue)
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.95,  0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.95,  0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   1.05,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  1.05,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.1,  -0.1,  -1.0),	rot = QuatEuler(-130, 15, 0.0),	vel = 0.1}
	end
	if actionValue == LSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.6,  -0.6),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.7,  0.5,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.8,  0.6,  -0.6),	rot = QuatEuler(-110, 0, 110.0),	vel = 0.0}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler(-5.0, 20.0,  0.0),	vel = 0.0}
	end
	if actionValue == PARRYING then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec(1.3,  0.75, -0.4),	rot = QuatEuler( 90.0,  90.0, -90.0),	vel = 0.8}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.3,  1.9,  -1.0),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(1.3,  0.75,  -0.4),	rot = QuatEuler(0, 0, 45.0),	vel = 0.8}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler(-5.0, -25.0,  0.0),	vel = 0.0}
	end
	if actionValue == LOAD_VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   2.2,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.7,  2.0,  -0.7),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.7,  2.2,  -0.7),	rot = QuatEuler(0, 0, 0.0),	vel = 0.8}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler(-5.0, -60.0,  0.0),	vel = 0.0}
	end
	if actionValue == LOAD_LSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.7,  -0.6),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.7,  -0.5),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(-0.8,  0.7,  -0.6),	rot = QuatEuler(50, 0, 70.0),	vel = 0.0}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler( -5.0,  45.0,  0.0),	vel = 0.0}
	end
	if actionValue == GUARDBREAK then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.4,   1.6,  -0.9),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.3,  1.4,  -1.1),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.3,  1.6,  -1.1),	rot = QuatEuler(30, 0, 0.0),	vel = 0.8}
	end
	if actionValue == STUN then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 1.3,   0.6,  -0.3),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.8,  0.6,  -0.4),	rot = QuatEuler(40.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(1.1,  0.6,  -0.6),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	end

	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-10.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.8,   1.2),	rot = QuatEuler(-45.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.9,  -0.6),	rot = QuatEuler(15.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   1.05,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.6}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  1.05,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.1,  -0.1,  -1.0),	rot = QuatEuler(-80, 15, 0.0),	vel = 0.1}
	end
	if actionValue == LSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.6,  -0.6),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.7,  0.5,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	if actionValue == PARRYING then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec(1.3,  0.75, -0.4),	rot = QuatEuler( 90.0,  90.0, -90.0),	vel = 0.8}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(0.3,  1.9,  -1.0),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(1.3,  0.75,  -1.3),	rot = QuatEuler(0, 0, 45.0),	vel = 0.8}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler(-5.0, -25.0,  0.0),	vel = 0.0}
	end
	if actionValue == LOAD_VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   2.2,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(1.0,  2.0,  -0.8),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.7,  2.2,  -0.7),	rot = QuatEuler(0, 0, 0.0),	vel = 0.8}
		a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.0,   0.0),	rot = QuatEuler(-5.0, -60.0,  0.0),	vel = 0.0}
	end
	if actionValue == LOAD_LSLICE then
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-10.0, 0.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.55,  1.0),	rot = QuatEuler(-80.0, 0.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.95,  0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.8}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   1.05,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.8}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  1.05,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-10.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.9,  -0.6),	rot = QuatEuler(15.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.8,   1.2),	rot = QuatEuler(-45.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   1.05,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.6}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  1.05,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.6,  -0.8),	rot = QuatEuler(0, 0, 0.0),	vel = 0.3}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
		a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.1,  -0.1,  -1.0),	rot = QuatEuler(-80, 15, 0.0),	vel = 0.1}
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,  0.65,   0.0),	rot = QuatEuler(-10.0, 0.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4, -0.95,  0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.8}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4, -0.55,  1.0),	rot = QuatEuler(-80.0, 0.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   1.05,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.8}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  1.05,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
	...
	----[[
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-5.0, -40.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.8,   0.0),	rot = QuatEuler( 0.0, -45.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.8,   0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.0}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.7,  1.35, -0.4),	rot = QuatEuler( 0.0,  0.0, -90.0),	vel = 0.0}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec( 0.6,   1.35, -0.8),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-15.0, -55.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.8,   1.2),	rot = QuatEuler(-45.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.9,  -0.6),	rot = QuatEuler(15.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,  1.35, -0.2),	rot = QuatEuler(90.0, 90.0, -90.0),	vel = 0.6}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec( 0.7, 1.35, -0.8),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	a.poses[#a.poses + 1] = {}
	a.poses[#a.poses]["torso"] = 		{pos = Vec( 0.0,   0.65,   0.0),	rot = QuatEuler(-15.0, -40.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.55,  1.0),	rot = QuatEuler(-80.0, 0.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.95,  0.0),	rot = QuatEuler( 0.0,  0.0,  0.0),	vel = 0.8}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.7,  1.35, -0.2),	rot = QuatEuler(90.0, 90.0, -90.0),	vel = 0.8}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec( 0.6,   1.35, -0.8),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.8}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	a.poses[#a.poses]["rightFoot"] = 	{pos = Vec( 0.4,  -0.9,  -0.6),	rot = QuatEuler(15.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["leftFoot"] = 	{pos = Vec(-0.4,  -0.8,   1.2),	rot = QuatEuler(-45.0, 0.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.6,   1.35, -0.2),	rot = QuatEuler(90.0, 90.0, -90.0),	vel = 0.6}
	a.poses[#a.poses]["leftHand"] = 	{pos = Vec( 0.5,  1.35, -0.8),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.6}
	a.poses[#a.poses]["weapon"] = 	{pos = Vec(0.6,  0.4,  -0.8),	rot = QuatEuler(-10, 0, 0.0),	vel = 0.0}
	if actionValue == VSLICE then
		a.poses[#a.poses]["rightHand"] = 	{pos = Vec( 0.8,   0.4,  -0.5),rot = QuatEuler(30.0, 150.0, -10.0),vel = 0.0}
		a.poses[#a.poses]["leftHand"] = 	{pos = Vec(-0.3,  0.4,  -0.6),	rot = QuatEuler(90.0, -160.0, 0.0),	vel = 0.0}
	...
	for i=1, #balls do
		...
		for k=1, #bodyShapes do
			if IsShapeTouching(shapeBall, bodyShapes[k]) and VecLength(GetBodyVelocity(balls[i])) > 30 then
				humanoid.health = humanoid.health - 34
...
function tick(dt)
	...
	if first then
		...
		MakeHole(humanoid.bodyCenter, 8, 8, 8, true)
		first = false
		for i=1, #humanoid.allBodies do
	...
	local staminaDamage = getStaminaDamageInRegistry() * 2
	...
	if getHitInRegistry(identifier) and invulnerability.value <= 0 then
		...
		if fight.action ~= PARRYING then
			if fight.action ~= BLOCK then
				...
				local dmg = getDamageAmountInRegistry() / 2
	...
	if VecDist(humanoid.playerPos, humanoid.bodyCenter) <= damageRange and angleToPlayer <= maxAngle then
		if fight.action == VSLICE or fight.action == COMBO or fight.action == LSLICE then
